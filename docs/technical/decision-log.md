...
- **Historical redaction boundary:** The founder's remove-everywhere instruction authorizes only the vendor-name redactions in the two 2026-08-11 decision records and the matching 2026-08-11 handoff entry. Their substantive facts and conclusions remain. This narrow exception neither weakens the append-only handoff rule nor authorizes other historical rewriting. The 2026-08-18 non-rewrite statement concerns the founder, his employer, and the litigation rationale for not naming the company on public assets, as that entry states, and stands unchanged.
