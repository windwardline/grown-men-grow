...
- [x] Founder authorized the DNS change.
- [x] Existing DNS records were recorded before modification.
- [x] Mail-related records remain intact after the DNS change.
- [x] HTTPS and canonical redirects work.
- [ ] Ghost owner and Instagram accounts use founder-controlled 2FA.
- [x] No credentials, member exports, or confidential files are tracked by Git.

## Instagram

- [x] Account is a public Creator account before launch posts are published.
- [x] Username, name, bio, and profile image are approved and live.
