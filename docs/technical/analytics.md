...
Use the approved direct Ghost URL with stable launch attribution:

`https://grownmengrow.com/start-here/?utm_source=instagram&utm_medium=social&utm_campaign=launch`

Keep it off the Instagram profile until the public destination is authorized and live.

Track:

- Instagram profile and link activity where available.
- Ghost visitors and views.
- Instagram referral traffic.
- Free signups attributed to Instagram.
...
- Referrals and signups from Medium, Bluesky, LinkedIn, Substack, Ghost Social Web, and search.
