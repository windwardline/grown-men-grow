---
title: Every Part Passed Inspection
slug: every-part-passed-inspection
dek: Nothing went out of spec. The door still doesn’t close.
...
Every dimension carries a second number in smaller type.

Plus or minus five thousandths — the engineer admitting nothing gets made exactly.

## Slide 3

Six parts, each allowed five thousandths, all drifting the same way.

The far end sits thirty thousandths off. Not one bad part in it.

## Slide 4

A man runs the audit at a bad hour and it comes back clean.

The job was right. The move was right. There is no affair in the file.

## Slide 5

Innocence is not a repair. It is a finding.

## Slide 6

Fault is an inspection. It looks backward, returns a verdict, and is finished.

Responsibility is a gauge. It reads the same number whether it was his fault or nobody's.

## Slide 7

Somebody has to hold the gauge against the part.

There is exactly one man standing in front of it.
