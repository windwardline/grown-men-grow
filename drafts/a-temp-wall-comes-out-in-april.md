...
## The load has to reach the ground
...
Somebody fills them before the floor gets refinished. The filler dries a shade light, the way it always does.

The room goes into use.
...
Before a saw goes near the studs, a second wall goes up three feet away, out of whatever lumber is in the truck.

## Slide 3

A temp wall is not support. It is a transfer.

The weight has to keep going — down the studs, through the plate, onto a footing sitting in dirt.

## Slide 4

“Let me know if you need anything” is a wall built with no path to the ground.

It goes up in four seconds. It is sincere. It carries nothing.

## Slide 5

The first two weeks are well staffed. People know what to do with two weeks.

That is not the shoring. That is the demolition crew, and demolition draws a crowd.

## Slide 6

Nobody frames a temp wall plumb.

It is not going to be there in April.

## Slide 7

Somebody fills the four holes before the floor gets refinished.

The filler dries a shade light. The room goes into use.

# Instagram caption source

Taking a bearing wall out of a house is mostly the business of not taking it out yet. Before a saw goes near the studs, a second wall goes up three feet away, out of whatever lumber is in the truck. Sole plate screwed through the finish floor, studs at sixteen inches, two shims tapped in at the top until the plate stops moving.
...
- Slide 1: Title A Temp Wall Comes Out in April above a photograph of a rough temporary stud wall standing in a stripped-open room with daylight behind it, and a drawn load-path mark of a short bar over a post in the lower corner.
- Slide 2: Serif text about a second wall going up three feet away out of whatever lumber is in the truck, above a drawn load-path mark whose post stops short of the hatched ground line.
- Slide 3: Sparse page reading A temp wall is not support, it is a transfer, above a drawn load-path mark whose post now runs the full distance to the hatched ground line.
- Slide 4: A photograph of two opposing cedar shims tapped between a temporary top plate and a ceiling joist, above serif text about an offer of help being a wall built with no path to the ground.
- Slide 5: Two heavy strips contrasting the well-staffed first two weeks with the shoring, with serif text beneath and a drawn load-path mark in the lower corner.
- Slide 6: Sparse page reading Nobody frames a temp wall plumb, it is not going to be there in April.
- Slide 7: A photograph of a hand drawing a putty knife across four filled screw holes in an oak floor in daylight, above the closing lines and a drawn load-path mark showing a beam seated on the hatched ground line with the post gone.

# Visual direction

- Family: **Field Note** — image-led, with type-led and mark-led slides between the photographs so no two consecutive slides share a skeleton. The run is image, mark, type, image, type, type, image.
- Signature: a hand-drawn **load-path mark** — a short horizontal load bar above a vertical post above a hatched ground line, where the post is only drawn as far as the load has actually travelled. It stops well short of the ground early, runs the full distance at the turn, and on the closing slide the post is gone and the bar sits directly on a beam seated on the hatched line. Used by no other note.
- Palette: Paper and Paper Light grounds, Ink and Oxblood type, Rust for the unsupported post, Green for the seated beam on the final slide.
- Photography, all three generated for this note under the house prompt and unique to it:
  - `assets/source/editorial/temp-wall-open-room.png` — the temporary stud wall standing in a stripped opening. Slide 1 and the feature image.
  - `assets/source/editorial/shims-top-plate.png` — the opposing shims at the top plate. Slide 4 and the feature image.
  - `assets/source/editorial/filled-holes-floor.png` — the filled screw holes in the oak. Slide 7.
- The renderer asserts that no photograph belonging to another article appears in this composition.

# Production notes

- Written 2026-08-30 by the Saturday draft task, against the standing commission `witness` recorded in `docs/technical/operating-cadence.md`. Not founder-approved. Nothing here is authorized for publication, newsletter delivery, or posting.
- Stance is `witness`. The subject test passes: the wall comes out on a schedule he did not set, and there is no move available to him inside the event. The three gates are held — no imperative aimed at the reader and no closing question, nothing liftable in the shape "so a man should ___", and the cared-for man is the grammatical object throughout while the givers' verbs carry the piece.
- The piece never certifies that the care landed well. The deflections and the errors are in: the reason line, the man who is gone by March, the hour at the kitchen table, the coffee can of screws, and his own resentment of the arrangement.
- Register is the generic present. No event is asserted as having happened, no composite is asserted, and no first person appears. The writer's own story does not go first and does not appear at all.
- **The loss is deliberately unnamed.** The essay says there is a Thursday with a funeral in it and never says whose. That is principle 4 — receiving the man on his own terms rather than projecting which wall came out of his house — and it also keeps the draft clear of asserting a particular event.
- Departure from the two prior `witness` pieces: both open on the machinery and then run the counter-case as a standalone disclaimer paragraph. Here the counter-case is delivered through the mechanism instead — a man with no path to ground puts the load into the floor and gets a hump in a hallway eight years later — because a third repetition of "one driveway is not a statistic" would be a formula rather than an honesty.
