...
Men maintain everything they value.

Oil that hasn't failed. Decks against rain that hasn't fallen. Smoke detectors, twice a year.

## Slide 3

Then we put the friendships we'd run into traffic for on a schedule of never.

## Slide 4

A real friendship should survive neglect — that's the myth.

Nobody calls a truck worthless because it needed brakes.

## Slide 5

History is why the friendship stands.

It is not why the lights are on.
...
- All imagery newly generated under the no-repeat rule and the full-resolution believability gate.
