...
# Field Note 14 — platform adaptations
...
**Stance note for whoever schedules this.** This is a `witness` piece, and the platform copy is held to the same three gates as the essay. No post asks the reader to do anything, none closes on a question, and none can be lifted as "so a man should ___." The usual social instinct — end the post on a turn to the reader so it performs — is the exact thing that would convert this piece into an assignment on the way out the door. The posts end on facts.

**Feed-tile note.** Field Note 14's carousel cover is image-led on `ladder-against-eave-autumn.png`, which appears in no other asset. Check the live feed for an image-led neighbour on a similar exterior-daylight subject before queueing the Instagram slot; the repository gate can see photograph collisions but not what Buffer has already sent.
...
A gutter has nothing to do with keeping the roof dry. The roof handles that on its own. The gutter is there for the six inches of dirt at the bottom of the wall.
...
They set the ladder on the soft ground, miss the back valley, and put the extension back pointed at the wall. He taps the window. Nobody has ever heard a window. [canonical link]
...
The back goes in October. Or the knee, or the shoulder, or the surgery that has been on the calendar since June and manages to be a surprise anyway. The leaves come down on the same schedule they always do. Nothing about a maple is tracking his year.
...
Nobody has ever climbed a ladder out of concern for a gutter. They go up because of the wall. The gutter gets maintained as a consequence of being the thing standing between the water and something that matters. [canonical link]
