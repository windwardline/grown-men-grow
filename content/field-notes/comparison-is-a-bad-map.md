...
Two garden beds, one street. One is taller.

The difference is real. There are no instructions in it.

## Slide 3

You’re reading someone else’s odometer and calling it a route.

## Slide 4

A man steering by other men isn’t going anywhere in particular.

He’s staying in formation.

## Slide 5

The only useful comparison: you, against you, over time.

Same driver. Same roads. Honest odometer.

## Slide 6

Other men are a library, not a map.

The question: do I actually want that — or do I just want to have it?

## Slide 7

Want the thing? Study the man. Run your own route.

Want to have it? Close the map.

# Instagram caption source

Two garden beds, side by side. One is a foot taller. A man can stand between them and learn exactly one thing: they’re different. There are no instructions in the difference.
...
- Slide 1: Title Comparison Is a Bad Map above a photograph of two neighboring garden beds at different heights in morning light, with a small dashed-path mark.
- Slide 2: Serif text about two garden beds on one street, with a short dashed line splitting into two.
- Slide 3: Sparse italic page reading You’re reading someone else’s odometer and calling it a route.
- Slide 4: A close photograph of a car odometer and dashboard in daylight, above strips reading A man steering by other men is staying in formation.
- Slide 5: Serif page reading The only useful comparison: you, against you, over time, with a dashed loop returning to its start.
- Slide 6: Old photographs and a notebook spread on a wooden table, above Other men are a library, not a map.
- Slide 7: Closing page reading Want the thing? Study the man. Want to have it? Close the map.

# Visual direction

- Family: Recognition; object-led, paired-things imagery. Signature: a hand-drawn dashed path that loops back to its own start, beside key phrases. No prior vocabularies.
- Lead: two neighboring garden beds at obviously different heights, bright morning.
- Details: a clean car odometer and dashboard in daylight; a man's own old photographs and a notebook spread on a table.
