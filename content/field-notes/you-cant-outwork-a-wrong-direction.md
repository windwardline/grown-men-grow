...
There’s a kind of lost only disciplined men achieve:

miles from the truck, making excellent time, exactly the wrong way.

## Slide 3

Every mile of effort buys another mile of wrong.

## Slide 4

When direction is uncertain, more effort feels like an answer.

It’s measurable. It’s virtuous. It’s a hiding place.

## Slide 5

The compass questions: If this works completely — what do I have?

Who set this course? What’s the cost-per-mile lately?

## Slide 6

Turning is not quitting.

The endurance transfers. The discipline transfers. Only the wrong heading gets left behind.

## Slide 7

Engine off. Map out.

Most checks confirm the course. Once in a while, the map saves you the strong miles.
...
- Slide 1: Title You Can’t Outwork a Wrong Direction above a photograph of a man studying a paper map spread on a truck hood in bright morning light, with a small drawn compass-fork mark.
- Slide 2: Serif text about the kind of lost only disciplined men achieve, with a drawn fork of two diverging arrows.
- Slide 3: Sparse italic page reading Every mile of effort buys another mile of wrong.
- Slide 4: A sunlit trail forking two ways in open woods, above strips reading More effort feels like an answer — measurable, virtuous, a hiding place.
- Slide 5: Serif page listing the compass questions, with a diverging-arrows mark.
- Slide 6: A handheld compass held over a folded map, above Turning is not quitting — the endurance transfers.
- Slide 7: Closing page reading Engine off. Map out, with one arrow of the drawn fork now bolded.

# Visual direction

- Family: Field Note; image-led, outdoor daylight. Signature: a hand-drawn fork of two diverging arrows (one faint, one committed) beside key phrases. No prior vocabularies.
- Lead: a man studying a paper map on a truck hood, morning light.
- Details: a sunlit trail fork in open woods; a handheld compass over a folded map.
