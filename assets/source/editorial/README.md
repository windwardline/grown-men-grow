...
### `anode-rod-pulled.png`

- Status: banked 2026-09-02; passed the full-resolution believability gate. The spent rod is technically right — bare steel core between knuckles of white scale, hex head intact — and the bench, cloth folds, shadow direction and background water heater all hold. No synthetic tell.
- Consumers: `scripts/render-field-note-17.mjs` — carousel cover (slide 1) and the feature-image dominant
- Prompt:
...
### `water-heater-top-fittings.png`

- Status: banked 2026-09-02 on the **second** generation. The first was rejected at the gate: two arms entered the frame, one in a dark sweater sleeve with a watch and one bare past the wrist, which reads either as two people or as one man whose sleeve vanished — an object-continuity tell, and one tell rejects the image. The lower hand's grip on the tank edge was also strained. The replacement holds: one arm, one hand, correct hot, cold and anode-port layout with red and blue seals, thread tape at the fitting, no readable text or brand plate.
- Consumers: `scripts/render-field-note-17.mjs` — carousel slide 4 and the feature-image inset
- Prompt as sent for the banked image:

  > The water-heater fittings image has a continuity failure: two arms enter the frame, one in a dark sweater sleeve with a watch and one bare past the wrist, so it reads either as two people or as one person whose sleeve vanished. Make a new image replacing it, same editorial photography style, portrait orientation 2:3, single image. The top of a domestic water heater seen close, the hex head of the anode port and the two threaded fittings in clean focus with fresh pipe dope at one thread; the image suggests routine maintenance done properly and on time. A tidy utility closet with swept floor and daylight reaching it. Exactly one hand and one forearm in the whole frame, entering from a single side, sleeve pushed to the elbow, no second hand and no second arm anywhere. Contemporary editorial photography with the polish of a major men's magazine, natural texture, restrained fine film grain, candid rather than posed. Asymmetric composition with clean negative space. Even daylight, warm, optimistic, grounded. Adult subject, pristine natural anatomy, maintained welcoming setting, no logos, no readable text, no watermark. Avoid: a second arm or second hand, mismatched sleeves, hands from two different people, fingers merging into the tank, cobwebs, corroded fittings, hoarded storage, mechanical-room gloom, brand plates, warning labels, anything readable.

### `tap-running-hot.png`

- Status: banked 2026-09-02; passed the full-resolution believability gate. Kitchen is maintained and in use, daylight is natural, steam is restrained rather than cinematic, and the water column has correct turbulence.
- Review note: the stream meets the basin with very little splash or standing water. It reads as a wet basin at editorial scale and is not a synthetic tell, but it is the softest physics in this set and is recorded rather than smoothed over.
- Consumers: `scripts/render-field-note-17.mjs` — carousel close (slide 7)
- Prompt:
