...
const requiredFiles = [
  ...
  'scripts/render-field-note-20.mjs',
  ...
  'scripts/lib/week-buffer-posts.mjs',
  ...
  'scripts/test/week-buffer-posts.test.mjs',
  ...
  'docs/technical/substack-notes.md',
...
if (tracked.includes('drafts/field-note-21-everything-comes-to-him-flat.md')
...
if (tracked.includes('drafts/field-note-23-everything-looks-straight-in-primer.md')
...
await validateAssetFamily('assets/drafts/instagram/field-note-20-carousel', 7, 1080, 1350);
...
const editorialSources = new Map([
  ...
  ['driveway-house-dusk-dash', { width: 1024, height: 1536 }],
  ['control-relay-din-rail', { width: 1024, height: 1536 }],
  ['relay-contacts-open-bench', { width: 1024, height: 1536 }],
...
const reviewSheets = new Map([
  ...
  ['field-note-20-carousel', { width: 1362, height: 1004 }],
