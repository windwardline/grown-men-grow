...
<section class="post-feed-wrap" aria-label="Latest writing">
  <div class="post-feed">
    <article class="post-card post-card--feature">
      <a class="post-card__media" href="/output/playwright/theme-post.html" aria-label="Read Strength Has to Grow Up">${featurePicture("/assets/drafts/ghost/feature-images/strength-has-to-grow-up.png", "A wooden chair mid-repair beside a tidy workbench of hand tools, in a paper collage")}</a>
    ...
    <article class="post-card">
      <a class="post-card__media" href="#">${featurePicture("/assets/drafts/ghost/feature-images/start-here.png", "A sunlit writing table beside running shoes waiting at a front door, in a paper collage")}</a>
    ...
    <article class="post-card">
      <a class="post-card__media" href="#">${featurePicture("/assets/drafts/ghost/feature-images/about.png", "Two friends cooking breakfast beside hands repotting a balcony plant, in a paper collage")}</a>
...
const startHere = `<article class="page page--start-here">
  ...
  <figure class="page-feature page-feature--start-here">${featurePicture("/assets/drafts/ghost/feature-images/start-here.png", "A sunlit writing table beside running shoes waiting at a front door, in a paper collage")}</figure>
...
const about = `<article class="page page--about">
  ...
  <figure class="page-feature">${featurePicture("/assets/drafts/ghost/feature-images/about.png", "Two friends cooking breakfast beside hands repotting a balcony plant, in a paper collage")}</figure>
